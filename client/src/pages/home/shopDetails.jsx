...
export default function ShopDetails() {
  ...
  const handleChatNow = () => {
    ...
    if (user.role !== "customer") {
      toast.error("Only customers can chat with shops");
      return;
    }

    // Navigate to customer conversation page
    navigate(`/messages/customer/${user.id}/shop/${id}`);
  };
        ...
        <div className="bg-white rounded-2xl shadow-lg p-4 mb-4">
          ...
          <div className="flex gap-2 mt-4">
            <button
              ...
              className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-lg font-semibold shadow-md transition-colors flex items-center justify-center gap-2"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <a
              href={`tel:${shop.phone}`}
              className="w-12 h-12 bg-white border-2 border-orange-500 text-orange-500 rounded-lg flex items-center justify-center hover:bg-orange-50 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="none"
